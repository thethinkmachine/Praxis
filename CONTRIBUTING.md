...
Praxis is easiest to extend when new algorithms, games, labs, and sandboxes are added through the existing registries and module contracts rather than by growing page-local `switch` logic.

This guide explains how the codebase is organized, what kind of contribution you are making, which files you need to touch, and how to validate the result before opening a PR.
