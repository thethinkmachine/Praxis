...
const DEMO_PROBLEMS: Record<AlgorithmCategory, DemoProblem[]> = {
  'uninformed-search': [
    ...
    },
    {
      id: 'grid-maze',
      name: 'Grid Maze',
      description: 'A 6×6 grid graph where each cell connects to orthogonal neighbours. Great for seeing how frontier expands across a 2D space.',
      difficulty: 'hard',
      estimatedSteps: 80,
      hint: 'BFS expands as a growing diamond shape; DFS races to one corner first.',
      tags: ['grid', 'maze', '2D'],
    },
  ],
};
